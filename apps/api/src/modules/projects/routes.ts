...
const createProjectSchema = z.object({
  ...
  type: z.enum(['FULL_TIME', 'PART_TIME', 'FREELANCE', 'SIDE_GIG', 'INTERNSHIP', 'TOOLBOX']).default('FREELANCE'),
  category: z.string(),
...
// Valid enum values
const VALID_PROJECT_TYPES = ['FULL_TIME', 'PART_TIME', 'FREELANCE', 'SIDE_GIG', 'INTERNSHIP', 'TOOLBOX'];
